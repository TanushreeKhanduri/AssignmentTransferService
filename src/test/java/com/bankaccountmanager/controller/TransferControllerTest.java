...
import com.bankaccountmanager.advice.ExceptionAdvice;
...
public class TransferControllerTest {
    ...
    public void testTransfer() throws Exception {
        ...
        String servicePath = String.format(com.bankaccountmanager.util.TestDataUtils.FORMAT_SERVICE_MULTI_PARAM_PATH,
